...
public class InputOutputEx {
    public static void main(String[] args) throws Exception
    {
        ...
        FileInputStream inputStream = new FileInputStream("C:\\myrepo\\less\\3\\data.txt");
        // Создаем поток-записи-байт-в-файл
        FileOutputStream outputStream = new FileOutputStream("C:\\myrepo\\less\\3\\result.txt");
